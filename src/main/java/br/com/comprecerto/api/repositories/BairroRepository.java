...
//	Bairro findByNomeAndCidadeAndEstadoAndPais(Bairro bairro);
	...
	@Query("select b from Bairro b" + //
			...
			" and b.cidade.nome = ?2" + //
			" and b.cidade.estado.nome = ?3")
	Bairro findByNomeAndCidadeAndEstado(String nome, String nomeCidade, String nomeEstado);
	...
	@Query("SELECT DISTINCT b FROM Cidade c JOIN c.bairros b JOIN b.mercadoLocalidades ml WHERE c.idCidade=?1 and ml.fAtivo=true and ml.mercado.idMercado=?2")	
