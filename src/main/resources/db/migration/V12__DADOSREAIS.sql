...
INSERT INTO sheap.servico (nome, f_ativo, dt_criacao, dt_alteracao) VALUES ('Boost Super Destaque', true, current_date, current_date);
...
INSERT INTO sheap.servico (nome, f_ativo, dt_criacao, dt_alteracao) VALUES ('Alcance de Retirada', true, current_date, current_date);
...
INSERT INTO sheap.pacote_servico (f_ativo, nome, descricao, valor, id_servico, dt_criacao, dt_alteracao) VALUES (true, 'Pacote Light', '480', 1440, (SELECT id_servico FROM sheap.servico WHERE nome = 'Anúncio de produtos'), current_date, current_date);
INSERT INTO sheap.pacote_servico (f_ativo, nome, descricao, valor, id_servico, dt_criacao, dt_alteracao) VALUES (true, 'Pacote Premium', '720', 2160, (SELECT id_servico FROM sheap.servico WHERE nome = 'Anúncio de produtos'), current_date, current_date);
INSERT INTO sheap.pacote_servico (f_ativo, nome, descricao, valor, id_servico, dt_criacao, dt_alteracao) VALUES (true, 'Pacote Deluxe', '960', 2880, (SELECT id_servico FROM sheap.servico WHERE nome = 'Anúncio de produtos'), current_date, current_date);
INSERT INTO sheap.pacote_servico (f_ativo, nome, descricao, valor, id_servico, dt_criacao, dt_alteracao) VALUES (true, 'Pacote 1', '16', 120, (SELECT id_servico FROM sheap.servico WHERE nome = 'Boost Destaque'), current_date, current_date);
INSERT INTO sheap.pacote_servico (f_ativo, nome, descricao, valor, id_servico, dt_criacao, dt_alteracao) VALUES (true, 'Pacote 2', '32', 220, (SELECT id_servico FROM sheap.servico WHERE nome = 'Boost Destaque'), current_date, current_date);
INSERT INTO sheap.pacote_servico (f_ativo, nome, descricao, valor, id_servico, dt_criacao, dt_alteracao) VALUES (true, 'Pacote 3', '48', 300, (SELECT id_servico FROM sheap.servico WHERE nome = 'Boost Destaque'), current_date, current_date);
INSERT INTO sheap.pacote_servico (f_ativo, nome, descricao, valor, id_servico, dt_criacao, dt_alteracao) VALUES (true, 'Pacote 4', '64', 450, (SELECT id_servico FROM sheap.servico WHERE nome = 'Boost Destaque'), current_date, current_date);
INSERT INTO sheap.pacote_servico (f_ativo, nome, descricao, valor, id_servico, dt_criacao, dt_alteracao) VALUES (true, 'Pacote 1', '16', 280, (SELECT id_servico FROM sheap.servico WHERE nome = 'Boost Super Destaque'), current_date, current_date);
INSERT INTO sheap.pacote_servico (f_ativo, nome, descricao, valor, id_servico, dt_criacao, dt_alteracao) VALUES (true, 'Pacote 2', '32', 504, (SELECT id_servico FROM sheap.servico WHERE nome = 'Boost Super Destaque'), current_date, current_date);
INSERT INTO sheap.pacote_servico (f_ativo, nome, descricao, valor, id_servico, dt_criacao, dt_alteracao) VALUES (true, 'Pacote 3', '48', 790, (SELECT id_servico FROM sheap.servico WHERE nome = 'Boost Super Destaque'), current_date, current_date);
...
INSERT INTO sheap.pacote_servico (f_ativo, nome, descricao, valor, id_servico, dt_criacao, dt_alteracao) VALUES (true, 'Pacote 1', '1', 200, (SELECT id_servico FROM sheap.servico WHERE nome = 'Push Plus'), current_date, current_date);
INSERT INTO sheap.pacote_servico (f_ativo, nome, descricao, valor, id_servico, dt_criacao, dt_alteracao) VALUES (true, 'Pacote 2', '2', 360, (SELECT id_servico FROM sheap.servico WHERE nome = 'Push Plus'), current_date, current_date);
INSERT INTO sheap.pacote_servico (f_ativo, nome, descricao, valor, id_servico, dt_criacao, dt_alteracao) VALUES (true, 'Pacote 3', '3', 500, (SELECT id_servico FROM sheap.servico WHERE nome = 'Push Plus'), current_date, current_date);
INSERT INTO sheap.pacote_servico (f_ativo, nome, descricao, valor, id_servico, dt_criacao, dt_alteracao) VALUES (true, 'Pacote 4', '4', 730, (SELECT id_servico FROM sheap.servico WHERE nome = 'Push Plus'), current_date, current_date);
INSERT INTO sheap.pacote_servico (f_ativo, nome, descricao, valor, id_servico, dt_criacao, dt_alteracao) VALUES (true, 'Pacote 1', '1', 560, (SELECT id_servico FROM sheap.servico WHERE nome = 'Push Direct'), current_date, current_date);
INSERT INTO sheap.pacote_servico (f_ativo, nome, descricao, valor, id_servico, dt_criacao, dt_alteracao) VALUES (true, 'Pacote 2', '2', 1.010, (SELECT id_servico FROM sheap.servico WHERE nome = 'Push Direct'), current_date, current_date);
INSERT INTO sheap.pacote_servico (f_ativo, nome, descricao, valor, id_servico, dt_criacao, dt_alteracao) VALUES (true, 'Pacote 3', '3', 1.570, (SELECT id_servico FROM sheap.servico WHERE nome = 'Push Direct'), current_date, current_date);
INSERT INTO sheap.pacote_servico (f_ativo, nome, descricao, valor, id_servico, dt_criacao, dt_alteracao) VALUES (true, 'Único', 'x', 500, (SELECT id_servico FROM sheap.servico WHERE nome = 'Alcance de Retirada'), current_date, current_date);
